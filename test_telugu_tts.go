...
func main() {
	// Telugu test text
	teluguText := `"చూడండి, ఇక్కడ ఒక చిన్న కొలను ఉంది!" అంది రాణి, ఆశ్చర్యంగా. నీరు మెరుస్తూ ఉంది, అందులో చేపలు ఈదుతున్నాయి. నీరు ఎలా వస్తుందో తెలుసా? వర్షం ద్వారా! వర్షపు నీరు చెరువుల్లోకి, నదుల్లోకి చేరుతుంది. ప్రకృతిలో నీరు ఇలా ప్రయాణిస్తుంది!`
	// debugVothulu()
